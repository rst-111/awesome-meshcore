...
| :--- | :--- | :---: | :--- |
| [Meshcore Open](https://github.com/zjs81/meshcore-open) | Cross-platform FOSS client app for phones | ![GitHub Repo stars](https://img.shields.io/github/stars/zjs81/meshcore-open?style=social)| Dec 25 |
